    ...
    (async () => {
      ...
      Location.watchHeadingAsync((h) => {
        ...
        setSmoothHeading(prev => {
          // Fix the 360/0 degree wrap-around jump for stable rotation
      ...
      <View style={styles.container}>
        ...
        <View style={styles.cardsWrapper}>
          <TouchableOpacity style={styles.card}>
            <Image source={require('../../assets/req_drone.png')} style={styles.bgImage}/>
            <View style={styles.overlay}/>
            <Text style={styles.cardText}>Request Drone Service</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.card} onPress={() => setShowMap(true)}>
            <Image source={require('../../assets/view_map.png')} style={styles.bgImage}/>
            <View style={styles.overlay}/>
            <Text style={styles.cardText}>View Map</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.card}>
            <Image source={require('../../assets/history.png')} style={styles.bgImage}/>
            <View style={styles.overlay}/>
        ...
        <>
            ...
            >
              {location && (
                <Marker coordinate={location} anchor={{ x: 0.5, y: 0.5 }}>
                  <View style={[styles.googleMarkerContainer, { transform: [{ rotate: `${getArrowRotation()}deg` }] }]}>
          ...
          <View style={styles.bottomBar}>
            ...
            <View style={styles.rightControls}>
              <TouchableOpacity onPress={toggleMapMode} style={styles.recenterButton}>
                <Ionicons
              ...
              <TouchableOpacity onPress={toggleCompassExpanded}>
                <View style={styles.compassRing}>
                  ...
                  <View style={[styles.arrowContainer, { transform: [{ rotate: `${smoothHeading}deg` }] }]}>
        ...
        <View style={styles.expandedContainer}>
          <View style={styles.largeCompassWrapper}>
            <View style={styles.largeCompassRing}>
              ...
              <View style={[styles.largeArrowContainer, { transform: [{ rotate: `${smoothHeading}deg` }] }]}>
          ...
          <TouchableOpacity style={styles.speakerButton} onPress={speakInstructions}>
            <Ionicons name="volume-high" size={36} color="#FFF" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.mapThumbnail} onPress={toggleCompassExpanded}>
            <MapView
            ...
            <TouchableOpacity style={styles.thumbnailRecenter} onPress={toggleMapMode}>
              <Ionicons
                name={mapMode === 'north-up' ? 'navigate' : 'compass'}
                size={20}
                color="#4285F4"
...
const styles = StyleSheet.create({
  ...
  googleMarkerArrow: {
    ...
    borderLeftColor: 'transparent',
    borderRightColor: 'transparent',
    borderBottomColor: 'rgba(66, 133, 244, 0.4)', // Faded blue beam pointing forward
  },
  googleMarkerDot: {
    width: 20,
    height: 20,
  ...
  speakerButton: {
    ...
    height: 70,
    borderRadius: 35,
    backgroundColor: 'rgba(66, 133, 244, 0.2)', // Subtly tinted blue
    justifyContent: 'center',
    alignItems: 'center',
    borderWidth: 1,
    borderColor: '#4285F4',
